...
export const coordinateInterview = async (candidateName: string, candidateEmail: string, candidatePhone: string, jobTitle: string, recruiterName: string) => {
...
export const generateOutreach = async (candidateName: string, candidateContext: string, jobContext: string, customInstruction?: string) => {
